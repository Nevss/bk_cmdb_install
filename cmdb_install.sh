...
wget https://media.githubusercontent.com/media/Nevss/bk_cmdb_install/master/redis-3.2.11.tar.gz && tar xf redis-3.2.11.tar.gz
wget https://media.githubusercontent.com/media/Nevss/bk_cmdb_install/master/zookeeper-3.4.12.tar.gz && tar xf zookeeper-3.4.11.tar.gz
wget https://media.githubusercontent.com/media/Nevss/bk_cmdb_install/master/cmdb-3.0.6.tar.gz && tar xf cmdb-3.0.6.tar.gz

wget https://media.githubusercontent.com/media//Nevss/bk_cmdb_install/master/node-v4.5.0.tar.gz && tar xf node-v4.5.0.tar.gz
